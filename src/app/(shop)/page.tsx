            ...
            <div className="grid gap-3 sm:grid-cols-3">
              ...
              {featured.products.filter((p) => p.category === "cd").map((product) => (
                <div
                  ...
                  style={{ borderColor: "rgba(255,255,255,0.06)", background: "rgba(200,160,80,0.03)" }}
                >
                  <div className="relative aspect-square overflow-hidden" style={{ background: "#1A1610" }}>
                    <Image src={product.image_url} alt={product.name} fill={true} className="object-contain p-4" />
                  </div>
                  <div className="flex flex-1 flex-col p-3 sm:p-4">
