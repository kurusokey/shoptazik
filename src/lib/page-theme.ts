...
const themes: Record<string, PageTheme> = {
  ...
  // Rimeurs à Gages — bleu marine sombre / accents or
  "rimeurs-a-gages": {
    headerBg: "rgba(10,20,40,0.95)",
    headerBorder: "1px solid rgba(212,184,48,0.12)",
    logo: "#D4B830",
    linkColor: "rgba(255,255,255,0.35)",
    linkHover: "white",
    ...
    badgeText: "#0A1428",
    footerBg: "#060E1C",
    footerBorder: "1px solid rgba(212,184,48,0.1)",
    footerText: "rgba(255,255,255,0.3)",
    footerMuted: "rgba(212,184,48,0.1)",
  },
