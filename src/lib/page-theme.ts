...
const themes: Record<string, PageTheme> = {
  ...
  // Rimeurs à Gages — jaune moutarde/bleu marine
  "rimeurs-a-gages": {
    headerBg: "rgba(180,160,40,0.92)",
    headerBorder: "1px solid rgba(26,58,122,0.2)",
    logo: "#1A3A7A",
    linkColor: "rgba(26,26,26,0.5)",
    linkHover: "#1A1A1A",
    accentName: "Rimeurs à Gages",
    accentHref: "/artists/fdy-phenomen/rimeurs-a-gages",
    accentColor: "#1A3A7A",
    cartBg: "rgba(26,58,122,0.1)",
    cartBorder: "1px solid rgba(26,58,122,0.2)",
    badgeBg: "#1A3A7A",
    badgeText: "white",
    footerBg: "#2A2400",
    footerBorder: "1px solid rgba(26,58,122,0.15)",
