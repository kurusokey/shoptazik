...
export default function BuyAlbumDigital({ title, artist, trackCount, price }: BuyAlbumDigitalProps) {
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <h3 className="font-semibold text-white">{title} &mdash; Album num&eacute;rique</h3>
